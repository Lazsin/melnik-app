...
export default function Help() {
  return (
    <section className="text-center grid max-w-[500px] mx-auto py-24 px-6 justify-center">
      <div className="help-text mb-10">
        <h1 className="text-3xl font-semibold mb-4 text-gray-800">
          Давайте обговоримо, чим я можу вам допомогти?
        </h1>
        <p className="mx-auto w-[70%] leading-relaxed text-gray-700">
      ...
      <form className="grid justify-items-center w-full">
        <input
          ...
          className="w-full p-3 mb-5 border border-gray-300 rounded-lg bg-gray-100 text-gray-800 text-base outline-none focus:border-[#25a0b5] focus:ring-2 focus:ring-[#25a0b5] transition duration-300"
        />
        <input
          type="email"
        ...
        <textarea
          ...
          rows="4"
          className="w-full p-3 mb-6 border border-gray-300 rounded-lg bg-gray-100 text-gray-800 text-base outline-none focus:border-[#25a0b5] focus:ring-2 focus:ring-[#25a0b5] transition duration-300 resize-none"
        />
